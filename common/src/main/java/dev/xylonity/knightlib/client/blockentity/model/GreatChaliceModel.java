...
public class GreatChaliceModel extends GeoModel<GreatChaliceBlockEntity> {
    ...
    public ResourceLocation getModelResource(GreatChaliceBlockEntity animatable) {
        return new ResourceLocation(KnightLibCommon.MOD_ID, "geo/great_chalice.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GreatChaliceBlockEntity animatable) {
        return switch (animatable.getState()) {
            case CHAOTIC -> new ResourceLocation(KnightLibCommon.MOD_ID, "textures/block/great_chalice_chaotic.png");
            default -> // EMPTY/NORMAL
                    new ResourceLocation(KnightLibCommon.MOD_ID, "textures/block/great_chalice.png");
        };
    }

    @Override
    public ResourceLocation getAnimationResource(GreatChaliceBlockEntity animatable) {
        return new ResourceLocation(KnightLibCommon.MOD_ID, "animations/great_chalice.animation.json");
    }
