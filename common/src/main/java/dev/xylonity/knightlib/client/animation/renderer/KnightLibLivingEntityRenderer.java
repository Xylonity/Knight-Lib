...
public abstract class KnightLibLivingEntityRenderer<T extends LivingEntity & KnightLibAnimatable> extends LivingEntityRenderer<T, KnightLibLivingModel<T>> {
    ...
    protected KnightLibLivingEntityRenderer(EntityRendererProvider.Context context, float shadowRadius) {
    ...
    protected KnightLibLivingEntityRenderer(EntityRendererProvider.Context context) {
        this(context, 0.5f);
    }
