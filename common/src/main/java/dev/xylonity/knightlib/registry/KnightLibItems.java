...
public class KnightLibItems {
    ...
    public static final ResourceRegistry<Item> ITEMS = ResourceDispatcher.create(ResourceType.ITEMS, KnightLibCommon.MOD_ID);
    ...
    public static final ResourceEntry<Item> GREAT_CHALICE = ITEMS.register("great_chalice", KnightLibCommon.PLATFORM.createItem("great_chalice", new Item.Properties(), ItemType.GREAT_CHALICE));
