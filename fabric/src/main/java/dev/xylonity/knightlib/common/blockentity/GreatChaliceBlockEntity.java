...
public class GreatChaliceBlockEntity extends BlockEntity implements GeoBlockEntity {
    ...
    public GreatChaliceBlockEntity(BlockPos pos, BlockState state) {
        super(KnightLibBlockEntities.GREAT_CHALICE, pos, state);
    ...
    protected void saveAdditional(@NotNull CompoundTag pTag, HolderLookup.@NotNull Provider pRegistries) {
        ...
        pTag.putInt("Charges", charges);
        pTag.putInt("PrevCharges", prevCharges);
        pTag.putString("State", state.getSerializedName());
    }
    ...
    protected void loadAdditional(@NotNull CompoundTag pTag, HolderLookup.@NotNull Provider pRegistries) {
        ...
        try {
            state = GreatChaliceState.valueOf(pTag.getString("State").toUpperCase());
        } catch (Exception e) {
