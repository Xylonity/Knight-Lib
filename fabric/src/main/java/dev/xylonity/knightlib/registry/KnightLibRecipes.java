...
public final class KnightLibRecipes {
    ...
    static {
        CHALICE_SERIALIZER = Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, KnightLib.of("great_chalice_interaction"), GreatChaliceRecipe.SERIALIZER);
        CHALICE_TYPE = Registry.register(BuiltInRegistries.RECIPE_TYPE, KnightLib.of("great_chalice_interaction"), GreatChaliceRecipe.RECIPE_TYPE);
    }
