...
public class MenuScreenRegistrationEventFabric extends MenuScreenRegistrationEvent {
    ...
    @Override
    public <M extends AbstractContainerMenu, S extends Screen & MenuAccess<M>> void register(MenuType<M> menuType, MenuScreenRegistrationEvent.ScreenFactory<M, S> screenFactory) {
