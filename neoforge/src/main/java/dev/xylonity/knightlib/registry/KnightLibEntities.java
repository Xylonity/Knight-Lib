...
public class KnightLibEntities {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY = DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, KnightLib.MOD_ID);

    public static final Supplier<EntityType<GreatChaliceStartsetRing>> GREAT_CHALICE_STARSET_RING;
