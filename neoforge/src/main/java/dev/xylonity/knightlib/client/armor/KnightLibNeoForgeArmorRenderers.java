...
/**
 * NeoForge renderer cache shared by its armor-model and armor-texture hooks
 */
public final class KnightLibNeoForgeArmorRenderers {
    ...
    private KnightLibNeoForgeArmorRenderers() {
        ;;
    }
